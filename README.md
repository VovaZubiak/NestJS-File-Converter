...
Веб-додаток для безпечної конвертації медіафайлів та документів.
**Стек:** NestJS (Backend) + Python (Worker) + FFmpeg.

## Можливості
* **Зображення:** JPG, PNG, WEBP, GIF, PDF
* **Відео/Аудіо:** MP4, AVI, MOV, MP3, WAV
* **Документи:** DOCX → PDF, TXT → PDF, PDF → TXT
